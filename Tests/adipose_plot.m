...
hold on;
text(y(end)/2 - 70,x(end*3/4) - 30, 'Point Source' ,'FontSize',16,'FontName','Times New Roman' , 'FontWeight', 'Bold');
plot(y(end)/2,x(end*3/4),'*r','MarkerSize', 8);
plot([x(1),x(end)],[y(10),y(10)],'r','LineWidth',3);
text(x(end)/2 - 300,-45,'Phase Conjugating Mirror', 'FontSize',16,'FontName','Times New Roman' , 'FontWeight', 'Bold');
